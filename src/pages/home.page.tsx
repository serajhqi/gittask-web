...
export default function Home() {
  return <h1 className="flex gap-4 h-[calc(100vh-120px)]">
    ...
    <div className="w-80 flex-1 h-full gap-2 flex flex-col">
      <div className="flex h-56 border-2 border-black rounded-2xl">
        <div className="w-80 h-full">
          <TaskDetails />
        </div>
